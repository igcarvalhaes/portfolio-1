      ...
      <main className="flex flex-col min-h-[100dvh] space-y-10">
        <section id="hero">
          <div className="mx-auto w-full max-w-2xl space-y-8">
            <div className="gap-4 flex flex-col-reverse items-center sm:flex-row sm:justify-between sm:items-start sm:gap-2">
              ...
              <BlurFade delay={BLUR_FADE_DELAY}>
                <Avatar className="size-28 border sm:size-28">
            ...
            <BlurFade delay={BLUR_FADE_DELAY * 13}>
              <div className="flex flex-col items-center justify-center space-y-4 text-center">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    Compartilhando conhecimentos e experiências sobre
                    desenvolvimento
                  </p>
                </div>
              </div>
                ...
                .map((post, id) => (
                  ...
                  >
                    <Link href={`/blog/${post.slug}`}>
                      <div className="flex flex-col space-y-2 p-4 rounded-lg border bg-card hover:bg-accent transition-colors">
            ...
            <BlurFade delay={BLUR_FADE_DELAY * 16}>
              <div className="space-y-3">
                ...
                <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Quer conversar? Envie uma mensagem direta{" "}
                  <Link
